...
//            }
    ...
    {
        $sql = "SELECT o.order_id, o.order_status_id, o.date_modified FROM `" . DB_PREFIX . "order` o WHERE o.order_status_id > '0' AND o.store_name = 'Магазин Вконтакте' AND TIMESTAMP(o.date_modified) >= TIMESTAMP('" . $this->db->escape($data['filter_date_modified']) . "') ORDER BY o.order_id ASC";
