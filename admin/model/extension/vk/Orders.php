...
class Orders
{
    ...
    {
        $this->db->query(
            "INSERT INTO " . DB_PREFIX . "vk_orders SET " . DB_PREFIX . "id = '" . (int)$data[DB_PREFIX . 'id'] . "', " . DB_PREFIX . "status = '" . (int)$data[DB_PREFIX . 'status'] . "', vk_id = '" . (int)$data['vk_id'] . "', vk_status = '" . (int)$data['vk_status'] . "', vk_user_id = '" . (int)$data['vk_user_id'] . "', json_last_event = '" . $this->db->escape(json_encode($data['json_last_event'], true)) . "'");
    }
