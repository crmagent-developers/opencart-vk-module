...
class OpencartApiClient {
    ...
    {
        return $this->request('vk/getDeliveryTypes', array(), array());
    }
    ...
    {
        $this->request('vk/addOrderHistory', array(), array('order_id' => $order_id, 'order_status_id' => $order_status_id));
    }
}
